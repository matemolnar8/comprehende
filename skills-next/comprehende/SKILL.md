...
8. When they ask to upload the report, follow Export. Otherwise run `npx comprehende@0.6.0 serve --data "$REVIEW_DIR/review.json" --open` and give the user the localhost URL (`127.0.0.1` only).
