...
Review concern 04 of 05: Skill teaches the string forms (`skill`)

Part: File refs

The why:

The agent writes review.json from the skill and the example. Those texts have to name the path form and the compact form.
