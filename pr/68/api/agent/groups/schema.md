...
Review concern 01 of 08: Case schema and flags (`schema`)

Part: Report grader

The why:

Every later step loads `case.json` and argv. Those shapes have to be one contract.
...
- scripts/eval/case.ts @@ -0,0 +1,90 @@
- scripts/eval/args.ts @@ -0,0 +1,137 @@
- scripts/eval/constants.ts @@ -0,0 +1,6 @@