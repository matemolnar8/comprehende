...
Review concern 02 of 05: pages-review tests (`tests`)

Part: GitHub Pages reviews

The why:

The publish script is new git worktree code. Tests pin publish, sibling folders, close prune, and TTL.
...
- scripts/pages-review.test.ts @@ -0,0 +1,176 @@
