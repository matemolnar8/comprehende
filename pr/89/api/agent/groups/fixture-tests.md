...
Review concern 03 of 06: Fixture tests (`fixture-tests`)

Part: Mixed fixture

The why:

The mixed document and relative printout need tests so a later example-repo change fails here.
...
- scripts/build-fixture.test.ts @@ -0,0 +1,22 @@
- src/test/covering-document.test.ts @@ -0,0 +1,78 @@