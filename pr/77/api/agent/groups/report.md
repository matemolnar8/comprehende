...
Review concern 02 of 06: Text report (`report`)

Part: Compare reviews

The why:

The default CLI output needs a readable report of the same payload.
...
- src/review/compare-format.test.ts @@ -0,0 +1,71 @@
- src/review/compare-format.ts @@ -0,0 +1,208 @@