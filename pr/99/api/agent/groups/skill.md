...
2. Load the hunks.
   ...
   For each hunk ref, run `git diff --find-renames a05aef85c489e9ccd5c42f7b3397219b35b95719 84fb302df7ee6332f2c24cb5aba135f2a81540b3 -- <path>` and keep the hunk whose header matches the @@ range.
...
[#96](source:s1) names the skill-only C+D edits: batch commands, drop the schema pointer, list validate checks, fix lockfile wording, and write review.json once.
...
- skills-next/comprehende/SKILL.md @@ -53,7 +64,7 @@
