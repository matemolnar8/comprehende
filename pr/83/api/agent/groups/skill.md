...
Review concern 04 of 08: Skill writes parts[] (`skill`)

Part: Schema

The why:

[The request](source:s1) asks agents to write one `parts[]` entry per independent story.
...
- skills-next/comprehende/SKILL.md @@ -29,7 +29,7 @@
- skills-next/comprehende/SKILL.md @@ -72,6 +72,8 @@
- skills-next/comprehende/SKILL.md @@ -79,7 +81,7 @@
- skills-next/comprehende/references/example.md @@ -4,7 +4,7 @@
- skills-next/comprehende/references/example.md @@ -20,6 +20,16 @@